...
SELECT DISTINCT ON (symbol) 
  ...
  created_at
FROM public.prices 
WHERE symbol IN (SELECT ticker FROM public.instruments WHERE instrument_type = 'Bono')
ORDER BY symbol, timestamp DESC;

-- Insert sample bond instruments using correct enum values
INSERT INTO public.instruments (ticker, ticker_mep, instrument_type, issuer, rating, currency, maturity_date, face_value) VALUES
('AL30', 'AL30D', 'Bono', 'Republica Argentina', 'B', 'USD', '2030-07-09', 1000),
('GD30', 'GD30D', 'Bono', 'Republica Argentina', 'B', 'USD', '2030-07-09', 1000),
('AL35', 'AL35D', 'Bono', 'Republica Argentina', 'B', 'USD', '2035-07-09', 1000),
('GD35', 'GD35D', 'Bono', 'Republica Argentina', 'B', 'USD', '2035-07-09', 1000),
('AE38', 'AE38D', 'Bono', 'Republica Argentina', 'B', 'USD', '2038-01-09', 1000),
('GD38', 'GD38D', 'Bono', 'Republica Argentina', 'B', 'USD', '2038-01-09', 1000),
('AL41', 'AL41D', 'Bono', 'Republica Argentina', 'B', 'USD', '2041-07-09', 1000),
('GD41', 'GD41D', 'Bono', 'Republica Argentina', 'B', 'USD', '2041-07-09', 1000)
